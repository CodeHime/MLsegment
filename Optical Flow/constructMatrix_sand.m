function [A, b] = constructMatrix_sand( Ikx, Iky, Ikz, pd, pdfs, u, v ,num)
...
video1 = VideoReader('cut1.avi'); 
numFrames = video1.NumberOfFrames;

videoSource = vision.VideoFileReader('cut1.avi','ImageColorSpace','Intensity','VideoOutputDataType','uint8');
    
if(num==numFrames)
    detector = vision.ForegroundDetector(...
           'NumTrainingFrames', 260, ... 
