function [du, dv] = resolutionProcess_sand(Ikz, Ikx, Iky, alphaImg, omega, uinit, vinit, outer_iter, inner_iter, num) 
...
for i = 1 : outer_iter
	...
	[A, b] = constructMatrix_sand( Ikx, Iky, Ikz, psidash, psidashFS, u, v, num ) ;
